    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', django.contrib.postgres.fields.JSONField(default=None, blank=True, null=True)),
                ...
                ('diff', django.contrib.postgres.fields.JSONField(default=None, null=True)),
                ('snapshot', django.contrib.postgres.fields.JSONField(default=None, null=True)),
                ('values', django.contrib.postgres.fields.JSONField(default=None, null=True)),
