    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_options', django.contrib.postgres.fields.JSONField(null=True, verbose_name='default options', blank=True)),
                ('us_statuses', django.contrib.postgres.fields.JSONField(null=True, verbose_name='us statuses', blank=True)),
                ('points', django.contrib.postgres.fields.JSONField(null=True, verbose_name='points', blank=True)),
                ('task_statuses', django.contrib.postgres.fields.JSONField(null=True, verbose_name='task statuses', blank=True)),
                ('issue_statuses', django.contrib.postgres.fields.JSONField(null=True, verbose_name='issue statuses', blank=True)),
                ('issue_types', django.contrib.postgres.fields.JSONField(null=True, verbose_name='issue types', blank=True)),
                ('priorities', django.contrib.postgres.fields.JSONField(null=True, verbose_name='priorities', blank=True)),
                ('severities', django.contrib.postgres.fields.JSONField(null=True, verbose_name='severities', blank=True)),
                ('roles', django.contrib.postgres.fields.JSONField(null=True, verbose_name='roles', blank=True)),
            ],
            options={
